...
#define GE_BTN_RIGHT      SDL_BUTTON_RIGHT
#define GE_BTN_MIDDLE     SDL_BUTTON_MIDDLE
#define GE_BTN_BACK       SDL_BUTTON_X1
#define GE_BTN_FORWARD    SDL_BUTTON_X2
#define GE_BTN_WHEELUP    SDL_BUTTON_X2+1
#define GE_BTN_WHEELDOWN  SDL_BUTTON_X2+2
#define GE_BTN_WHEELLEFT  SDL_BUTTON_X2+3
#define GE_BTN_WHEELRIGHT SDL_BUTTON_X2+4
