...
static s_hidinput_ids ids[] = {
        ...
        MAKE_IDS(USB_DEVICE_ID_LOGITECH_WHEEL),
        MAKE_IDS(USB_DEVICE_ID_LOGITECH_MOMO_WHEEL),
        MAKE_IDS(USB_DEVICE_ID_LOGITECH_DFP_WHEEL),
        MAKE_IDS(USB_DEVICE_ID_LOGITECH_G25_WHEEL),
        MAKE_IDS(USB_DEVICE_ID_LOGITECH_DFGT_WHEEL),
        MAKE_IDS(USB_DEVICE_ID_LOGITECH_G27_WHEEL),
        MAKE_IDS(USB_DEVICE_ID_LOGITECH_WII_WHEEL),
        MAKE_IDS(USB_DEVICE_ID_LOGITECH_MOMO_WHEEL2),
...
typedef struct
{
    ...
    unsigned char command[FFB_LOGITECH_OUTPUT_REPORT_SIZE];
} s_native_mode;
