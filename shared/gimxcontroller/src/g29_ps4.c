...
static s_axis_name_dir axis_name_dirs[] =
{
  ...
  {.name = "wheel left",   {.axis = g29Ps4a_wheel,      .props = AXIS_PROP_CENTERED | AXIS_PROP_NEGATIVE}},
  {.name = "wheel right",  {.axis = g29Ps4a_wheel,      .props = AXIS_PROP_CENTERED | AXIS_PROP_POSITIVE}},
