...
static const struct {
    ...
    union {
        ...
        CONSTANT_TEST("G29 constant force (right, 50%)", USB_PRODUCT_ID_LOGITECH_G29_WHEEL, USB_PRODUCT_ID_LOGITECH_DFGT_WHEEL, 0, 50, 0, CONSTANT(0), CONSTANT(0x3f)),
        ...
        VARIABLE_TEST("G29 variable force (right, 50%)", USB_PRODUCT_ID_LOGITECH_G29_WHEEL, USB_PRODUCT_ID_LOGITECH_DFGT_WHEEL, 0, 50, 0, VARIABLE(0), CONSTANT(0x3f)),
