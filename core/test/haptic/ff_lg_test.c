...
static const struct {
    ...
    union {
        ...
        CONSTANT_TEST("G29 constant force (left, 100%)", USB_PRODUCT_ID_LOGITECH_G29_PS4_WHEEL, USB_PRODUCT_ID_LOGITECH_DFGT_WHEEL, 0, 100, 0, CONSTANT(0xff), VARIABLE(0xff)),
        CONSTANT_TEST("G29 constant force (right, 100%)", USB_PRODUCT_ID_LOGITECH_G29_PS4_WHEEL, USB_PRODUCT_ID_LOGITECH_DFGT_WHEEL, 0, 100, 0, CONSTANT(0), VARIABLE(0)),
        CONSTANT_TEST("G29 constant force (null, 100%)", USB_PRODUCT_ID_LOGITECH_G29_PS4_WHEEL, USB_PRODUCT_ID_LOGITECH_DFGT_WHEEL, 0, 100, 0, CONSTANT(127), VARIABLE(127)),

        CONSTANT_TEST("G29 constant force (left, 50%)", USB_PRODUCT_ID_LOGITECH_G29_PS4_WHEEL, USB_PRODUCT_ID_LOGITECH_DFGT_WHEEL, 0, 50, 0, CONSTANT(0xff), VARIABLE(0xbf)),
        CONSTANT_TEST("G29 constant force (right, 50%)", USB_PRODUCT_ID_LOGITECH_G29_PS4_WHEEL, USB_PRODUCT_ID_LOGITECH_DFGT_WHEEL, 0, 50, 0, CONSTANT(0), VARIABLE(0x3f)),
        CONSTANT_TEST("G29 constant force (null, 50%)", USB_PRODUCT_ID_LOGITECH_G29_PS4_WHEEL, USB_PRODUCT_ID_LOGITECH_DFGT_WHEEL, 0, 50, 0, CONSTANT(127), VARIABLE(127)),

        CONSTANT_TEST("G29 constant force (left, inverted, 100%)", USB_PRODUCT_ID_LOGITECH_G29_PS4_WHEEL, USB_PRODUCT_ID_LOGITECH_DFGT_WHEEL, 1, 100, 0, CONSTANT(0xff), VARIABLE(0)),
        CONSTANT_TEST("G29 constant force (right, inverted, 100%)", USB_PRODUCT_ID_LOGITECH_G29_PS4_WHEEL, USB_PRODUCT_ID_LOGITECH_DFGT_WHEEL, 1, 100, 0, CONSTANT(0), VARIABLE(0xff)),
        CONSTANT_TEST("G29 constant force (null, inverted, 100%)", USB_PRODUCT_ID_LOGITECH_G29_PS4_WHEEL, USB_PRODUCT_ID_LOGITECH_DFGT_WHEEL, 1, 100, 0, CONSTANT(127), VARIABLE(127)),
        ...
        VARIABLE_TEST("G29 variable force (left, 100%)", USB_PRODUCT_ID_LOGITECH_G29_PS4_WHEEL, USB_PRODUCT_ID_LOGITECH_DFGT_WHEEL, 0, 100, 0, VARIABLE(0xff), VARIABLE(0xff)),
        VARIABLE_TEST("G29 variable force (right, 100%)", USB_PRODUCT_ID_LOGITECH_G29_PS4_WHEEL, USB_PRODUCT_ID_LOGITECH_DFGT_WHEEL, 0, 100, 0, VARIABLE(0), VARIABLE(0)),
        VARIABLE_TEST("G29 variable force (null, 100%)", USB_PRODUCT_ID_LOGITECH_G29_PS4_WHEEL, USB_PRODUCT_ID_LOGITECH_DFGT_WHEEL, 0, 100, 0, VARIABLE(127), VARIABLE(127)),

        VARIABLE_TEST("G29 variable force (left, 50%)", USB_PRODUCT_ID_LOGITECH_G29_PS4_WHEEL, USB_PRODUCT_ID_LOGITECH_DFGT_WHEEL, 0, 50, 0, VARIABLE(0xff), VARIABLE(0xbf)),
        VARIABLE_TEST("G29 variable force (right, 50%)", USB_PRODUCT_ID_LOGITECH_G29_PS4_WHEEL, USB_PRODUCT_ID_LOGITECH_DFGT_WHEEL, 0, 50, 0, VARIABLE(0), VARIABLE(0x3f)),
        VARIABLE_TEST("G29 variable force (null, 50%)", USB_PRODUCT_ID_LOGITECH_G29_PS4_WHEEL, USB_PRODUCT_ID_LOGITECH_DFGT_WHEEL, 0, 50, 0, VARIABLE(127), VARIABLE(127)),

        VARIABLE_TEST("G29 variable force (left, inverted, 100%)", USB_PRODUCT_ID_LOGITECH_G29_PS4_WHEEL, USB_PRODUCT_ID_LOGITECH_DFGT_WHEEL, 1, 100, 0, VARIABLE(0xff), VARIABLE(0)),
        VARIABLE_TEST("G29 variable force (right, inverted, 100%)", USB_PRODUCT_ID_LOGITECH_G29_PS4_WHEEL, USB_PRODUCT_ID_LOGITECH_DFGT_WHEEL, 1, 100, 0, VARIABLE(0), VARIABLE(0xff)),
        VARIABLE_TEST("G29 variable force (null, inverted, 100%)", USB_PRODUCT_ID_LOGITECH_G29_PS4_WHEEL, USB_PRODUCT_ID_LOGITECH_DFGT_WHEEL, 1, 100, 0, VARIABLE(127), VARIABLE(127)),
