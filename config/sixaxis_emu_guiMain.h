...
class sixaxis_emu_guiFrame: public wxFrame
{
    ...
    private:
        ...
        void OnButtonTabControlsCellLeftClick2(wxGridEvent& event);
        void OnButtonTabControlsCellLeftClick3(wxGridEvent& event);
        ...
        void OnButtonTabRemoveClick(wxCommandEvent& event);
        void OnButton7Click(wxCommandEvent& event);
        void OnButtonTabEventTypeSelect1(wxCommandEvent& event);
        void OnChoice6Select(wxCommandEvent& event);
        void OnButtonTabControlsCellLeftClick4(wxGridEvent& event);
        ...
        void OnButtonTabControlsCellLeftClick5(wxGridEvent& event);
        ...
        void OnLSIncAutoDetectClick1(wxCommandEvent& event);
        ...
        wxStaticText* VarName3;
        wxStaticText* VarName26;
        wxStaticText* VarName11;
        wxStaticText* RSIncButtonId;
        wxMenuItem* MenuItem31;
        wxStaticText* VarName24;
        wxMenuItem* MenuItem8;
        wxButton* RSIncDelete;
        wxTextCtrl* AxisTabAcceleration;
        wxStaticText* VarName8;
        wxStaticText* VarName5;
        wxStaticText* RSDecDeviceName;
        wxMenuItem* MenuItem7;
        wxMenuItem* MenuItem26;
        wxStaticText* VarName12;
        wxMenuItem* MenuItem25;
        wxStaticText* ButtonTabDeviceId;
        wxNotebook* Notebook1;
        wxStaticText* LSDecDeviceId;
        wxStaticText* VarName19;
        wxStaticText* VarName16;
        wxStaticText* VarName22;
        ...
        wxGrid* ButtonTabControls;
        wxStaticText* VarName2;
        wxMenuItem* MenuItem28;
        wxButton* Button7;
        wxTextCtrl* AxisTabDeadZone;
        wxStaticText* VarName6;
        wxStaticText* RSIncDeviceType;
        wxStaticText* VarName20;
        wxStatusBar* StatusBar1;
        wxTextCtrl* AxisTabFilter;
        wxStaticText* VarName4;
        ...
        wxStaticText* VarName1;
        wxButton* ButtonTabRemove;
        wxStaticText* VarName10;
        wxSpinCtrl* LSSteps;
        wxStaticText* VarName17;
        wxPanel* Panel2;
        wxMenuItem* MenuItem21;
        wxStaticText* VarName23;
        wxMenuItem* MenuItem16;
        wxStaticText* VarName25;
        wxStaticText* ProfileTriggerDeviceId;
        wxMenu* Menu6;
        wxMenuItem* MenuItem9;
        wxStaticText* VarName15;
